      ...
      <div style={{ maxWidth: 520, width: '100%', textAlign: 'center', animation: 'fadeUp .4s var(--ease)' }}>
        ...
        {!isPro && (
          <div style={{
            ...
            <CrownIcon size={15} />
            <span style={{ flex: 1, textAlign: 'left' }}>Mejora tu cuenta y exporta tu CV en DOCX y sin marca</span>
...
function CrownIcon({ size = 15 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M2 19h20v2H2zM3 7l4 6 5-8 5 8 4-6v10H3z"/></svg>;
}
