    ...
    <LegalLayout title="Política de Privacidad" lastUpdated="24 de septiembre de 2026">
      ...
      <Section heading="2. Qué información recopilamos">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>Datos de cuenta: nombre, apellido, correo electrónico y contraseña, o la información básica de tu cuenta (nombre, correo, foto) si prefieres iniciar sesión con Google o LinkedIn.</li>
          ...
          <li>Contenido que nos compartes para generar tu perfil: mensajes que escribes en el chat y documentos que subas con tu información profesional (por ejemplo, un CV que ya tengas).</li>
          <li>Descripciones de vacantes que pegas para generar un CV adaptado a una oferta específica.</li>
          <li>Información de pago: si pagas por una descarga o por el Plan Pro, tu pago es procesado por pasarelas de pago externas — nosotros no almacenamos números de tarjeta ni claves privadas de billeteras; esos proveedores manejan esa información directamente.</li>
      ...
      <Section heading="3. Cómo usamos tu información">
        <ul className="list-disc pl-5 space-y-1">
          <li>Para generar tus CVs: tu información de perfil se procesa mediante tecnología de inteligencia artificial exclusivamente para redactar y estructurar el contenido de tus CVs. Esta tecnología está instruida para no inventar experiencia, logros ni habilidades que no hayas proporcionado — ver nuestra <a href="/uso-de-ia" className="underline">Política de Uso de IA</a>.</li>
      ...
      <Section heading="4. Con quién compartimos información">
        <p>
          Para operar Momentum, nos apoyamos en proveedores externos de infraestructura y tecnología —
          entre otros, alojamiento y almacenamiento seguro de datos, procesamiento de pagos, prevención de
          fraude y abuso, y tecnología de inteligencia artificial para generar contenido. Cada uno procesa
          únicamente la información necesaria para prestarnos su servicio, bajo obligaciones contractuales
          de confidencialidad, y no puede usar tu información para sus propios fines.
        </p>
        <p>
          Si eliges iniciar sesión con Google o LinkedIn, dichos proveedores verifican tu identidad y nos
          comparten únicamente la información básica de tu cuenta (nombre, correo, foto) que tú autorizas
          al conectar tu cuenta.
        </p>
        <p>
      ...
      <Section heading="5. Seguridad de la información">
        <p>
          Aplicamos controles de acceso para que cada usuario solo pueda ver y modificar su propia
          información, cifrado en tránsito (HTTPS) para todas las comunicaciones, y verificación
          automatizada (captcha) en los formularios de acceso para reducir intentos automatizados de
          acceso indebido. Ningún sistema es 100% seguro, pero trabajamos activamente para proteger tu
          información.
        </p>
      </Section>
      ...
      <Section heading="8. Cookies y tecnologías similares">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>Cookies de sesión de autenticación — te mantienen conectado a tu cuenta.</li>
