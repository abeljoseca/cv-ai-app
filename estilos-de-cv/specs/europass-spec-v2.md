...
| 41 | Imagen de muestra "se regenera automáticamente" (§11) | PNG generado con la plantilla y el paginador reales (`npm run samples`): portada recortada en la tarjeta del selector + "Ver ejemplo" con la hoja completa. Persona ficticia de demostración en **una sola hoja** (núcleo + foto, nacionalidad, permiso). Una prueba automática falla si la plantilla, el paginador, los datos o la foto de demostración cambian sin regenerar las imágenes. Foto de demostración: generada con IA por el CEO (silueta mientras tanto) (decisión CEO 2026-09-26) | La muestra nunca se desincroniza del resultado real |
